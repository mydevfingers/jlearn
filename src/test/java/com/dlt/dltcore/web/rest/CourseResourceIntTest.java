package com.dlt.dltcore.web.rest;

import com.dlt.dltcore.JlearningApp;

import com.dlt.dltcore.domain.Course;
import com.dlt.dltcore.repository.CourseRepository;
import com.dlt.dltcore.service.CourseService;
import com.dlt.dltcore.service.dto.CourseDTO;
import com.dlt.dltcore.service.mapper.CourseMapper;
import com.dlt.dltcore.web.rest.errors.ExceptionTranslator;
...
import static com.dlt.dltcore.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.dlt.dltcore.domain.enumeration.Level;
/**
...
@SpringBootTest(classes = JlearningApp.class)
public class CourseResourceIntTest {
    ...
    private static final Long DEFAULT_COURSE_DURATION = 1L;
    private static final Long UPDATED_COURSE_DURATION = 2L;
    ...
    public void getAllCourses() throws Exception {
        ...
        restCourseMockMvc.perform(get("/api/courses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].courseDuration").value(hasItem(DEFAULT_COURSE_DURATION.intValue())))
    ...
    public void getCourse() throws Exception {
        ...
        restCourseMockMvc.perform(get("/api/courses/{id}", course.getId()))
            ...
            .andExpect(jsonPath("$.courseDuration").value(DEFAULT_COURSE_DURATION.intValue()))
